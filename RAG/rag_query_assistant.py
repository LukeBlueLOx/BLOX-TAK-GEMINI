...
3.  **Metadata:** Na samym końcu odpowiedzi, pod nagłówkiem "--- METADATA ---", dodaj stopkę z metadanymi w następującym formacie:
    Użyty prompt (PL): [Wklej tutaj treść całego tego promptu, zaczynając od: {user_question}]
    Used prompt (EN): [Wklej tutaj dokładne tłumaczenie całego tego promptu na język angielski: {user_question}]
